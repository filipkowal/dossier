...
export default function Dialog({
  ...
  return (
    <dialog
      ...
      className="fixed inset-0 m-auto z-50 bg-digitalent-gray-light transform overflow-hidden text-digitalent-blue text-left align-middle shadow-all-sides transition-all w-240 max-w-full"
    >
